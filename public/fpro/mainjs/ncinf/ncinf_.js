...
$('#tipoRedH').val(1);
$('#periodoH').val();
function getHistoricoGY(periodo, tipo){
    $("#KYHistoricoTab").DataTable({
        destroy: true,
        ajax: '/getHistoricoGY?periodo=' + periodo + '&tipo=' + tipo + '&sap_code=' + $("#associateid").val(),
        dom: '<"row"<"col-md-12"<"row"<"col-md-6"B><"col-md-6"f> > ><"col-md-12"rt> <"col-md-12"<"row"<"col-md-5 mb-md-0 mb-5"i><"col-md-7"p>>> >',
        buttons: {
            buttons: [{ 
                extend: 'excel',
                title: 'Historico kinYa',
                className: 'btn btn-default btn-rounded btn-sm mb-4 btn-influencia-180 br-50',
                text:"<img src='https://services.nikken.com.mx/retos/img/excel.png' width='15px'></img> Exportar a Excel",
            }]
        },
