...
@section('title', 'Check de bonificaciones VC Plus')
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="homeCheckBonos">
                        ...
                        <span class="nav-link-text ms-1">Check Bonos VC Plus</span>
                    </a>
                </li>
            </ul>
        </div>
            ...
            <div class="col-md-3 mb-4">
                <div class="card">
                    <div class="card-header text-center pt-4 pb-3">
                        <span class="badge rounded-pill bg-light text-dark">Check de bonificaciones VC Plus</span>
                    </div>
...
<script>
    function reportCheckBonos(){
        ...
        if(socioCode != ''){
            window.open('/reportCheckBonos_vcplus?code=' + socioCode + '&period=' + periodSlct, '_blank');
        }
        else{
