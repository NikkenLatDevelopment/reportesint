...
class otros extends Controller
{
    public function estCHLexe()
    {
        ...
        # hoja 6
            ...
            $h = ['Código de Socio', 'Nombre', 'País', 'Rango', 'Periodo', 'VP Latam', 'VGP Latam', 'Cumple VP', 'Cumple VGP', 'Cumple', 'Cumple Incorporaciones', 'Código Patrocinador', 'Nombre patrocinador'];
            $d = $core->getReportBody("SELECT * FROM RETOS_ESPECIALES.dbo.EstrategiaGTM_SLV_EXE_ganadores_chl_gtm (202601,202612);", "SQL173", $h);
    ...
    public function estVHLideres()
    {
        ...
        # hoja 2
            ...
            $hoja3->mergeCells('A1:M1');
            $hoja3->setCellValue('A1', "Estrategia CHL Lideres | Fecha de actualización: " . Date("Y-m-d H:i:s"));
            $hoja3->getStyle('A1')->getFont()->setBold(true);

            $h = ['Código de Influencer', 'Nombre', 'País', 'Rango', 'Periodo', 'VP Latam', 'VGP Latam', 'Total de incorporaciones', 'Total Cumplen Estrategia', 'Cumple VP', 'Cumple VGP', 'Cumple Incorporaciones', 'Código Patrocinador', 'Nombre patrocinador'];
            $d = $core->getReportBody("SELECT * FROM RETOS_ESPECIALES.dbo.EstrategiaGTM_SLV_Lideres_ganadores_CHL_GTM (202601,202612);", "SQL173", $h);
            $hoja3->fromArray($d, null, 'A3', true);
        # hoja 2
    ...
    public function estGTMSLVexe()
    {
        ...
        // Enviar la respuesta para forzar la descarga
        $fileName = "Estrategia GTM y SLV Rangos Ejecutivos - " . Date('Y_m_d_H_i_s') . '.xlsx';
        return response()->stream(
            function () use ($tempFilePath) {
                readfile($tempFilePath);
                unlink($tempFilePath);
    ...
    public function estGTMSLVLideres()
    {
        ...
        # hoja 1
            ...
            $h = ['Código de Socio', 'Nombre', 'País', 'Rango', 'Periodo', 'VP Latam', 'VGP Latam', 'Incorporaciones totales', 'Total Cumplen Estrategia', 'Cumple VP', 'Cumple VGP', 'Cumple', 'Código Patrocinador', 'Nombre patrocinador'];
            $d = $core->getReportBody("SELECT Associateid,AssociateName,Pais,Rango,Periodo,VP_latam,VGP_latam,Total_incorporaciones,Total_cumplen_estrategia,CumpleVP,CumpleVGP,Cumple_Incorporaciones,Sponsorid,SponsorName FROM RETOS_ESPECIALES.dbo.EstrategiaGTM_SLV_Lideres(202401,202412) ORDER BY periodo ASC,total_incorporaciones DESC;", "SQL173", $h);
            $hoja1->fromArray($d, null, 'A3', true);
        # hoja 1
        ...
        # hoja 2
            ...
            $h = ['Código de Socio', 'Nombre', 'País', 'Rango', 'Periodo', 'VP Latam', 'VGP Latam', 'Incorporaciones totales', 'Total Cumplen Estrategia', 'Cumple VP', 'Cumple VGP', 'Cumple', 'Código Patrocinador', 'Nombre patrocinador'];
            $d = $core->getReportBody("SELECT Associateid,AssociateName,Pais,Rango,Periodo,VP_latam,VGP_latam,Total_incorporaciones,Total_cumplen_estrategia,CumpleVP,CumpleVGP,Cumple_Incorporaciones,Sponsorid,SponsorName FROM RETOS_ESPECIALES.dbo.EstrategiaGTM_SLV_Lideres(202501,202512) ORDER BY periodo ASC,total_incorporaciones DESC;", "SQL173", $h);
            $hoja2->fromArray($d, null, 'A3', true);
        # hoja 2
        ...
        # hoja 3
            ...
            $h = ['Código de Socio', 'Nombre', 'País', 'Rango', 'Periodo', 'VP Latam', 'VGP Latam', 'Incorporaciones totales', 'Total Cumplen Estrategia', 'Cumple VP', 'Cumple VGP', 'Cumple', 'Código Patrocinador', 'Nombre patrocinador'];
            $d = $core->getReportBody("SELECT Associateid,AssociateName,Pais,Rango,Periodo,VP_latam,VGP_latam,Total_incorporaciones,Total_cumplen_estrategia,CumpleVP,CumpleVGP,Cumple_Incorporaciones,Sponsorid,SponsorName FROM RETOS_ESPECIALES.dbo.EstrategiaGTM_SLV_Lideres(202601,202612) ORDER BY periodo ASC,total_incorporaciones DESC;", "SQL173", $h);
            $hoja3->fromArray($d, null, 'A3', true);
        # hoja 3
        ...
        // Enviar la respuesta para forzar la descarga
        $fileName = "Estrategia GTM y SLV Rangos Lideres - " . Date('Y_m_d_H_i_s') . '.xlsx';
        return response()->stream(
            function () use ($tempFilePath) {
                readfile($tempFilePath);
                unlink($tempFilePath);
