    ...
    public function reporteVip25(){
        ...
        # HOJA 1
            ...
            # TABLA 1
                ...
                $h = ['País', 'Platino', 'Diamante', 'Diamante Real', 'Ganadores Club viajero VIP'];
                $d = $core->getReportBody("EXEC RETOS_ESPECIALES.dbo.report_viajero_vip_caro 1;", "SQL173", $h);
                $d[] = ['Latinoamérica', '=SUM(B11:B19)', '=SUM(C11:C19)', '=SUM(D11:D19)', '=SUM(E11:E19)'];
                $hoja1->fromArray($d, null, 'A10', true);
                $hoja1->getStyle('A10:E20')->applyFromArray($bodyStyle);
                $hoja1->getStyle('A10:E10')->applyFromArray($headerStyle);
            ...
            # TABLA 2
                ...
                $h = ['País', 'Platino', 'Diamante', 'Diamante Real', 'Ganadores Club viajero VIP'];
                $d = $core->getReportBody("EXEC RETOS_ESPECIALES.dbo.report_viajero_vip_caro 2;", "SQL173", $h);
                $d[] = ['Latinoamérica', '=SUM(B29:B37)', '=SUM(C29:C37)', '=SUM(D29:D37)', '=SUM(E29:E37)'];
                $hoja1->fromArray($d, null, 'A28', true);
            ...
            # TABLA 3
                ...
                $h = ['País', 'Enero ', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio', 'Julio', 'Agosto', 'Septiembre', 'Octubre', 'Noviembre', 'Diciembre', '2025'];
                $d = $core->getReportBody("EXEC RETOS_ESPECIALES.dbo.report_viajero_vip_caro 3;", "SQL173", $h);
                $d[] = ['Latinoamérica', '=SUM(B45:B53)', '=SUM(C45:C53)', '=SUM(D45:D53)', '=SUM(E45:E53)', '=SUM(F45:F53)', '=SUM(G45:G53)', '=SUM(H45:H53)', '=SUM(I45:I53)', '=SUM(J45:J53)', '=SUM(K45:K53)', '=SUM(L45:L53)', '=SUM(M45:M53)', '=SUM(N45:N53)'];
                $hoja1->fromArray($d, null, 'A44', true);
            ...
            # TABLA 4
                ...
                $h = ['País', 'Enero ', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio', 'Julio', 'Agosto', 'Septiembre', 'Octubre', 'Noviembre', 'Diciembre', '2025'];
                $d = $core->getReportBody("EXEC RETOS_ESPECIALES.dbo.report_viajero_vip_caro 3;", "SQL173", $h);
                $d[] = ['Latinoamérica', '=SUM(B61:B69)', '=SUM(C61:C69)', '=SUM(D61:D69)', '=SUM(E61:E69)', '=SUM(F61:F69)', '=SUM(G61:G69)', '=SUM(H61:H69)', '=SUM(I61:I69)', '=SUM(J61:J69)', '=SUM(K61:K69)', '=SUM(L61:L69)', '=SUM(M61:M69)', '=SUM(N61:N69)'];
                $hoja1->fromArray($d, null, 'A60', true);
            ...
            # TABLA 5
                ...
                $h = ['País', 'Enero ', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio', 'Julio', 'Agosto', 'Septiembre', 'Octubre', 'Noviembre', 'Diciembre'];
                $d = $core->getReportBody("EXEC RETOS_ESPECIALES.dbo.report_viajeroVIP_caro_h1vtas 1;", "SQL173", $h);
                $d[] = ['Latinoamérica', '=SUM(B77:B85)', '=SUM(C77:C85)', '=SUM(D77:D85)', '=SUM(E77:E85)', '=SUM(F77:F85)', '=SUM(G77:G85)', '=SUM(H77:H85)', '=SUM(I77:I85)', '=SUM(J77:J85)', '=SUM(K77:K85)', '=SUM(L77:L85)', '=SUM(M77:M85)'];
                $hoja1->fromArray($d, null, 'A76', true);
            ...
            # TABLA 6
                ...
                $h = ['País', 'Enero ', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio', 'Julio', 'Agosto', 'Septiembre', 'Octubre', 'Noviembre', 'Diciembre'];
                $d = $core->getReportBody("EXEC RETOS_ESPECIALES.dbo.report_viajeroVIP_caro_h1vtas 2;", "SQL173", $h);
                $d[] = ['Latinoamérica', '=SUM(B92:B100)', '=SUM(C92:C100)', '=SUM(D92:D100)', '=SUM(E92:E100)', '=SUM(F92:F100)', '=SUM(G92:G100)', '=SUM(H92:H100)', '=SUM(I92:I100)', '=SUM(J92:J100)', '=SUM(K92:K100)', '=SUM(L92:L100)', '=SUM(M92:M100)'];
                $hoja1->fromArray($d, null, 'A91', true);
            ...
            # TABLA 7
                ...
                $h = ['País', 'Enero ', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio', 'Julio', 'Agosto', 'Septiembre', 'Octubre', 'Noviembre', 'Diciembre'];
                $d = $core->getReportBody("EXEC RETOS_ESPECIALES.dbo.report_viajeroVIP_caro_h1vtas 3;", "SQL173", $h);
                $d[] = ['Latinoamérica', '=SUM(B107:B115)', '=SUM(C107:C115)', '=SUM(D107:D115)', '=SUM(E107:E115)', '=SUM(F107:F115)', '=SUM(G107:G115)', '=SUM(H107:H115)', '=SUM(I107:I115)', '=SUM(J107:J115)', '=SUM(K107:K115)', '=SUM(L107:L115)', '=SUM(M107:M115)'];
                $hoja1->fromArray($d, null, 'A106', true);
        ...
        # HOHJA 2
            ...
            $hoja2->getStyle($range)->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID);
            $hoja2->getStyle($range)->getFill()->getStartColor()->setRGB($color);
            $h = ['Ranking', 'Código Socio', 'Nombre', 'Rango Actual', 'Rango Participación', 'Fecha del último rango', 'Estado', 'Correo electrónico', 'Teléfono Móvil', 'País', 'Ganador Club Viajero', 'Cantidad de avances Plata- 1 Semestre', 'Cantidad de avances Plata- 2 Semestre', 'Enero', 'Febrero', 'Marzo', 'Abril', 'Mayo', 'Junio', 'Julio', 'Agosto', 'Septiembre', 'Octubre', 'Noviembre', 'Diciembre', 'VGP Acumulado 2025', 'Cumple requisitos', 'Aplica a doble requisito'];
